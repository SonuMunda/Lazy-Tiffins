<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Lazy_Tiffins.Login" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Lazy Tiffins/Signin</title>
...
<body>
    ...
    <form id="signup" runat="server">
        <div class="form-container flex flex-col items-center justify-center bg-violet-400" style="height: 65vh; width: 100%">
            <div class="container p-4 flex items-center justify-center bg-white w-96 rounded-lg" style="height: 360px">

                <table style="width: 320px">
                    <tr>
                        <td>
                            <asp:Label runat="server" ID="responseMessage" Text=""></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="py-2">
                            <asp:Label ID="title" runat="server" Text="Sign in" CssClass="py-4 text-3xl font-bold text-violet-500"></asp:Label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="py-2">
                            <asp:TextBox ID="emails" CssClass="form-control block w-full  px-3 py-1.5 text-base normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600  focus:outline-none" placeholder="Email" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="py-2">
                            <asp:TextBox ID="pass" CssClass="form-control block w-full  px-3 py-1.5 text-base normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600  focus:outline-none" placeholder="Password" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="py-2">
                            <p class="text-gray-800 mt-2 text-center">
                                Not a member? <a href="Register.aspx"
